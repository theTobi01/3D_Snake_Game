...
// bool growSnake(Snake* snake, int snakeSize) {
//   int newSnakeSize = snakeSize + 1;
//   Snake* newSnake = (Snake*)malloc(newSnakeSize * sizeof(Snake)); // Create new array for the new snake body
